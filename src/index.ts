...
program.command('run').description('Run a prompt').argument('<prompt>').action(run);
program.command('replay').description('Replay a flow').argument('<flow>').action(replay);
program.command('refine').description('Refine a flow').argument('<flow>').action(refine);
